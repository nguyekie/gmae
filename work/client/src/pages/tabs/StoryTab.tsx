...
const QUEST_STEPS: QuestStep[] = [
  ...
  },
  {
    ...
    objective: "Sang Lò Rèn Lời Thề, đánh bại 4 Kỵ Sĩ Bội Ước. Sau chương này, bạn mở vòng chơi rèn đồ và trợ thủ đi cùng.",
  },
  {
    levelRequirement: 26,
    ...
    objective: "Sang Vùng Đất Lửa, đánh bại 6 Khổng Tượng Dung Nham để mở đường tới Vùng Đất Băng.",
  },
  {
    levelRequirement: 27,
    ...
    objective: "Đánh bại 4 Phượng Hoàng Tro Đỏ tại Vùng Đất Lửa để nhận nguyên liệu rèn cao cấp.",
  },
  {
    levelRequirement: 28,
    ...
    objective: "Sang Vùng Đất Băng, đánh bại 6 Chấp Chính Băng Phong để mở đường tới Vùng Đất Nước.",
  },
  {
    levelRequirement: 29,
    ...
    objective: "Đánh bại 4 Cự Nhân Pha Lê Băng tại Vùng Đất Băng.",
  },
  {
    levelRequirement: 30,
    ...
    objective: "Sang Vùng Đất Nước, đánh bại 6 Giao Long Triều Sâu để hoàn tất mạch vùng đất nguyên tố mới.",
  },
  {
    levelRequirement: 31,
    ...
    objective: "Đánh bại 4 Manta Vực Triều tại Vùng Đất Nước để săn nguyên liệu hiếm và đồ SSS+.",
  },
  {
    levelRequirement: 30,
    ...
    dialogue:
      "Thánh Kỵ Sĩ Sa Ngã đã được cân bằng lại thành boss thế giới cuối game. Hắn không còn khóa tiến độ chính tuyến, nhưng là mục tiêu săn chiến tích, nguyên liệu hiếm, trang bị thần thoại và đồ SSS+.",
    objective: "Đánh boss thế giới khi đủ lực chiến để săn đồ cực hiếm; boss mạnh hơn nhiều nhưng tỉ lệ rơi đồ mạnh cũng cao hơn.",
  },
];
