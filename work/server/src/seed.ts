...
const itemTypes = [
  ...
  { id: "apex_oblivion", name: "Hủy Diệt Đỉnh Nguyên (SSS+)", rarity: "sss_plus", slot: "weapon", base_stats: { atk: 180, def: 36, spd: 22, hp: 720, mp: 260 }, level_requirement: 50, description: "Vũ khí tuyệt đỉnh vượt xa đồ huyền thoại: sát thương, phòng thủ, sinh lực và tốc độ đều được khuếch đại cực hạn.", stackable: false, special: { passive: { drop_rate_bonus: 0.08, boss_drop_rate_bonus: 0.08, boss_damage_bonus: 0.75 }, skill: { id: "void_cleave", name: "Xén Hư Không", description: "Đòn chém xé lõi không gian, tăng mạnh sát thương lên boss và quái tinh anh." } } },
  { id: "celestial_judgement", name: "Thiên Phán Tuyệt Đỉnh (SSS+)", rarity: "sss_plus", slot: "weapon", base_stats: { atk: 165, def: 48, spd: 18, hp: 860, mp: 320 }, level_requirement: 50, description: "Thánh khí SSS+ thiên về sinh tồn và bộc phát sát thương ổn định.", stackable: false, special: { passive: { drop_rate_bonus: 0.07, boss_drop_rate_bonus: 0.07, elite_damage_bonus: 0.5 }, skill: { id: "star_sentence", name: "Tinh Phán", description: "Tập trung ánh sao thành đòn kết án, đặc biệt hiệu quả trước boss cuối." } } },
  { id: "astral_aegis", name: "Thánh Giáp Tinh Tú (SSS+)", rarity: "sss_plus", slot: "armor", base_stats: { def: 128, hp: 1250, mp: 180, atk: 36, spd: 10 }, level_requirement: 50, description: "Giáp SSS+ dành cho người muốn đứng vững trước các boss mạnh nhất.", stackable: false, special: { passive: { damage_reduction: 0.12, drop_rate_bonus: 0.05, boss_drop_rate_bonus: 0.05 } } },
  { id: "voidstar_helm", name: "Mũ Hư Tinh SSS+", rarity: "sss_plus", slot: "helmet", base_stats: { atk: 34, def: 96, spd: 12, hp: 720, mp: 220 }, level_requirement: 50, description: "Mũ SSS+ kết tinh từ sao hư không, tăng mạnh phòng thủ và sức mạnh khi săn boss.", stackable: false, special: { passive: { power_bonus: 45, drop_rate_bonus: 0.06, boss_drop_rate_bonus: 0.08 } } },
  { id: "riftlord_gauntlets", name: "Găng Chúa Rạn SSS+", rarity: "sss_plus", slot: "gloves", base_stats: { atk: 92, def: 58, spd: 20, hp: 380, mp: 120 }, level_requirement: 50, description: "Găng SSS+ giúp mỗi đòn đánh xé rạn không gian, thiên về sát thương và tốc độ.", stackable: false, special: { passive: { power_bonus: 60, drop_rate_bonus: 0.05, boss_drop_rate_bonus: 0.07 } } },
  { id: "celestial_steps", name: "Giày Thiên Hành SSS+", rarity: "sss_plus", slot: "boots", base_stats: { atk: 38, def: 54, spd: 46, hp: 460, mp: 180 }, level_requirement: 50, description: "Giày SSS+ cho phép lướt qua vết nứt Aether, tăng tốc độ và khả năng sống sót.", stackable: false, special: { passive: { power_bonus: 35, exp_bonus: 0.1, drop_rate_bonus: 0.05 } } },
  { id: "singularity_amulet", name: "Dây Chuyền Kỳ Điểm SSS+", rarity: "sss_plus", slot: "trinket", base_stats: { atk: 76, def: 76, spd: 18, hp: 560, mp: 460 }, level_requirement: 50, description: "Trang sức SSS+ chứa một kỳ điểm nhỏ, cộng toàn diện chỉ số và vận may săn đồ.", stackable: false, special: { passive: { power_bonus: 55, exp_bonus: 0.12, drop_rate_bonus: 0.12, boss_drop_rate_bonus: 0.12, potential_per_hour_bonus: 40 } } },
  { id: "mask_fortune_fox", name: "Cải Trang Hồ Ly May Mắn", rarity: "legendary", slot: "costume", base_stats: { spd: 8, hp: 120 }, level_requirement: 20, description: "Thay đổi ngoại hình khi mặc và tăng mạnh vận may săn đồ.", stackable: false, special: { appearance: "fortune_fox", passive: { drop_rate_bonus: 0.18, exp_bonus: 0.06 } } },
  { id: "cloak_void_child", name: "Cải Trang Ấu Linh Hư Không", rarity: "mythic", slot: "costume", base_stats: { atk: 24, def: 18, mp: 160 }, level_requirement: 28, description: "Áo choàng làm dáng nhân vật tối màu hơn, cộng sức mạnh và kinh nghiệm nhận được.", stackable: false, special: { appearance: "void_child", passive: { power_bonus: 30, exp_bonus: 0.12, drop_rate_bonus: 0.08 } } },
  { id: "regalia_shard_king", name: "Cải Trang Vương Giả Mảnh Vỡ", rarity: "sss_plus", slot: "costume", base_stats: { atk: 48, def: 48, hp: 520, mp: 220, spd: 14 }, level_requirement: 50, description: "Ngoại trang SSS+ cho người chơi cuối game, cộng toàn diện chỉ số đặc biệt.", stackable: false, special: { appearance: "shard_king", passive: { power_bonus: 70, exp_bonus: 0.2, drop_rate_bonus: 0.22, potential_per_hour_bonus: 30 } } },
  ...
  { id: "charm_double_potential", name: "Bùa Nhân Đôi Tiềm Năng", rarity: "rare", slot: "consumable", base_stats: {}, level_requirement: 1, stackable: true, description: "Dùng để nhận x2 tiềm năng khi đánh quái và boss trong 60 phút.", special: { use: { buff_type: "potential_gain", multiplier: 2, duration_minutes: 60 } } },
  { id: "charm_double_drop", name: "Bùa Nhân Đôi Rơi Đồ", rarity: "epic", slot: "consumable", base_stats: {}, level_requirement: 1, stackable: true, description: "Dùng để x2 tỷ lệ rơi đồ khi đánh quái và boss trong 60 phút.", special: { use: { buff_type: "drop_rate", multiplier: 2, duration_minutes: 60 } } },
  { id: "charm_double_gold", name: "Bùa Nhân Đôi Vàng", rarity: "rare", slot: "consumable", base_stats: {}, level_requirement: 1, stackable: true, description: "Dùng để nhận x2 vàng khi đánh quái và boss trong 60 phút.", special: { use: { buff_type: "gold_gain", multiplier: 2, duration_minutes: 60 } } },
];
...
const monsters = [
  ...
  },
  {
    ...
    drop_table: [
      ...
      { item_type_id: "mask_fortune_fox", chance: 0.035 },
    ],
  },
  {
    id: "rogue_construct",
  ...
  },
  {
    ...
    drop_table: [
      { item_type_id: "apex_oblivion", chance: 0.22 },
      { item_type_id: "celestial_judgement", chance: 0.18 },
      { item_type_id: "astral_aegis", chance: 0.16 },
      { item_type_id: "voidstar_helm", chance: 0.14 },
      { item_type_id: "riftlord_gauntlets", chance: 0.14 },
      { item_type_id: "celestial_steps", chance: 0.14 },
      { item_type_id: "singularity_amulet", chance: 0.12 },
      { item_type_id: "regalia_shard_king", chance: 0.08 },
      { item_type_id: "elemental_heart", chance: 0.2 },
      { item_type_id: "tidal_emperor_trident", chance: 0.16 },
      { item_type_id: "titan_sunderer", chance: 0.45 },
      { item_type_id: "water_shard_fragment", chance: 0.3 },
  ...
  // handleBossFight trong combat.ts) — nhiều người có thể cùng cày cho đến khi hạ gục hẳn.
  {
    ...
    drop_table: [
      { item_type_id: "apex_oblivion", chance: 0.14 },
      { item_type_id: "celestial_judgement", chance: 0.11 },
      { item_type_id: "astral_aegis", chance: 0.09 },
      { item_type_id: "voidstar_helm", chance: 0.09 },
      { item_type_id: "riftlord_gauntlets", chance: 0.09 },
      { item_type_id: "celestial_steps", chance: 0.09 },
      { item_type_id: "singularity_amulet", chance: 0.08 },
      { item_type_id: "cloak_void_child", chance: 0.1 },
      { item_type_id: "colossus_plate", chance: 0.24 },
      { item_type_id: "abyssal_fang_blade", chance: 0.34 },
      { item_type_id: "titan_sunderer", chance: 0.3 },
      { item_type_id: "oracle_veil", chance: 0.22 },
  ...
  },
  {
    ...
    drop_table: [
      ...
      { item_type_id: "mask_fortune_fox", chance: 0.05 },
    ],
  },
  {
    id: "crystal_yeti",
...
const quests = [
  ...
  },
  {
    ...
    objectives: [{ type: "kill", targetId: "oathbreaker_knight", count: 4, label: "Kỵ Sĩ Bội Ước" }],
    reward_exp: 3600,
    reward_gold: 2600,
  ...
  },
  {
    ...
    prerequisite_quest_id: null as string | null,
    dialogue_offer: "Sau Lò Rèn Lời Thề, các vùng đất nguyên tố bắt đầu tách khỏi Hư Không. Hãy vào Vùng Đất Lửa và hạ 6 Khổng Tượng Dung Nham để lấy Than Nguyên Sơ.",
    ...
    objectives: [{ type: "kill", targetId: "ember_colossus", count: 6, label: "Khổng Tượng Dung Nham" }],
    reward_exp: 4200,
    reward_gold: 3200,
  ...
  },
  {
    ...
    dialogue_offer: "Vùng Đất Băng đang khóa các dòng năng lượng sau lò rèn. Hãy đánh bại 6 Chấp Chính Băng Phong để mở nhịp cộng hưởng kế tiếp.",
    ...
    objectives: [{ type: "kill", targetId: "frostbound_archon", count: 6, label: "Chấp Chính Băng Phong" }],
    reward_exp: 5200,
    reward_gold: 4200,
  ...
  },
  {
    ...
    dialogue_offer: "Vùng Đất Nước là nơi ba mạch nguyên tố gặp nhau. Hạ 6 Giao Long Triều Sâu để thu Ngọc Triều và khép chuỗi cộng hưởng.",
    ...
    objectives: [{ type: "kill", targetId: "tide_serpent", count: 6, label: "Giao Long Triều Sâu" }],
    reward_exp: 6500,
    reward_gold: 5200,
  ...
  },
  {
    ...
    objectives: [{ type: "kill", targetId: "ember_phoenix", count: 4, label: "Phượng Hoàng Tro Đỏ" }],
    reward_exp: 3600,
    reward_gold: 2800,
  ...
  },
  {
    ...
    objectives: [{ type: "kill", targetId: "crystal_yeti", count: 4, label: "Cự Nhân Pha Lê Băng" }],
    reward_exp: 4300,
    reward_gold: 3600,
  ...
  },
  {
    ...
    objectives: [{ type: "kill", targetId: "abyssal_manta", count: 4, label: "Manta Vực Triều" }],
    reward_exp: 5200,
    reward_gold: 4600,
...
async function seed() {
  ...
  try {
    ...
    await pool.query(
      `UPDATE boss_state bs
       SET max_hp = m.hp,
           current_hp = CASE WHEN bs.current_hp <= 0 THEN 0 ELSE m.hp END
  ...
  await pool.query(`
    ...
    SELECT id, 'costume', NULL FROM characters
...
async function seedShop() {
  ...
  await pool.query(
    "DELETE FROM shop_items WHERE shop_id = $1 AND item_type_id IN ('potential_hourglass', 'aether_growth_core')",
    [shopId]
  );
  ...
  const shopItems = [
    ...
    { item_type_id: 'voidstar_helm', price: 180000, stock: 1 },
    { item_type_id: 'riftlord_gauntlets', price: 180000, stock: 1 },
    { item_type_id: 'celestial_steps', price: 180000, stock: 1 },
    { item_type_id: 'singularity_amulet', price: 220000, stock: 1 },
    { item_type_id: 'astral_aegis', price: 260000, stock: 1 },
    { item_type_id: 'rift_core', price: 1200, stock: 10 },
    { item_type_id: 'charm_double_potential', price: 1800, stock: 9999 },
    { item_type_id: 'charm_double_gold', price: 1800, stock: 9999 },
    { item_type_id: 'charm_double_drop', price: 4200, stock: 9999 },
    { item_type_id: 'mask_fortune_fox', price: 26000, stock: 1 },
    { item_type_id: 'cloak_void_child', price: 52000, stock: 1 },
  ];
